...
- [ ] **ART-02** — All scenes and organisms should look natural, not artificial, shiny, polished or CGI-like (U22, U27, U31, U38). Rejected baseline replaced in `1a7f261` and `431ffec`: five backgrounds, eight portraits and all developmental atlases regenerated. Independent visual acceptance/user response pending.
- [ ] **ART-03** — Specifically replace the unrealistic polished stump (U24, U31). Installed ordinary overcast woodland/stump image; phone crop inspected. Independent framing/style review pending.
- [ ] **ART-04** — Zoom out scene 3 (“under leaves”) and also scenes 4 and 5; show more surrounding things (U25–U26, U31). Wider environments installed and captured at three viewports; independent comparison pending.
...
- [ ] **AUDIO-02** — Subtle but audible tapping/changing; natural, not electronic (U11, U34, U37). Replaced electronic cues with generated fingertip-on-wood foley and suppressed duplicate bubbling taps. Signal bounds/actual decoding tested; perceived naturalness/volume still need listening.
